...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("GroupMusicBot/assets/font2.ttf", 30)
        font = ImageFont.truetype("GroupMusicBot/assets/font.ttf", 30)
        title_font = ImageFont.truetype("GroupMusicBot/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("GroupMusicBot/assets/play_icons.png")
